...
public class ModBlocks {
    public static final Block LOOT_GEN = registerBlock("loot_pile", new LootPile(FabricBlockSettings.of(Material.SOIL).strength(0.5F).nonOpaque()), ItemGroups.REDSTONE);
